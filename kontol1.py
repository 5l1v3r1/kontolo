...
class autoBrute:
	...
	def k(self,target):
		...
		for x in [self.user+"123",self.user+"12345",self.user+"123456",self.user+"1234",self.user+"12",self.user+"012",self.user+"1",self.user+"01",self.user,self.email,self.phone,self.number,self.654321,self.1q2w3e,self.123123,self.112233,self.1q2w3e4r,self.user+"321"]
